...
execute if score totem villager_guards.config matches 1 unless entity @s[nbt={HandItems:[{},{id:"minecraft:totem_of_undying"}]}] if entity @e[nbt={Item:{id:"minecraft:totem_of_undying"}},distance=..1.5] run function villager_guards:guard/totem