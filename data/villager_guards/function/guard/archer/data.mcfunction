...
data merge entity @s {Silent:1b,DeathLootTable:"minecraft:empty",PersistenceRequired:1b,CanPickUpLoot:1b,Health:40f,IsImmuneToZombification:1b,CustomName:'{"text":"Villager Guard"}',HandDropChances:[1.000F,1.00F],ArmorDropChances:[1.000F,1.000F,1.000F,1.000F]}