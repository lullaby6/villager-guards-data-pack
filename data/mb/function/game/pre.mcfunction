...
fill 8 -60 -8 8 -40 24 white_concrete
...
execute at @e[tag=marker.red.trader] run function mb:trader/summon {"team":"red"}
execute at @e[tag=marker.blue.trader] run function mb:trader/summon {"team":"blue"}
